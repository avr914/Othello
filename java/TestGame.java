    ...
    public static void main(String[] args) {
        if (args.length != 2 && args.length != 3) {
            ...
            String s
                ...
                + "    SimplePlayer, ConstantTimePlayer, BetterPlayer, MyPlayer, MyPlayerAlt - AIs\n"
                + "    Human - manual input\n"
        ...
        for (int i = 0; i < 2; i++) {
            ...
            } else if (args[i].equalsIgnoreCase("MyPlayer")) {
                players[i] = new MyPlayer();
            } else if (args[i].equalsIgnoreCase("MyPlayerAlt")) {
                players[i] = new MyPlayerAlt(); 
            } else if (args[i].equalsIgnoreCase("MyPlayerOpt")) {
                players[i] = new MyPlayerOpt();
            } else if (args[i].equalsIgnoreCase("OogeePlayer")) {
                players[i] = new OogeePlayer();
            } else if (args[i].equalsIgnoreCase("DeepKwok")) {
                players[i] = new DeepKwok();
